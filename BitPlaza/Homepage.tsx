          ...
          <View style={styles.content}>
            ...
            <View style={styles.mainContent}>
              ...
              <View style={styles.langButtons}>
                <TouchableOpacity style={styles.langButton}><Text style={styles.langButtonText}>Python</Text></TouchableOpacity>
                <TouchableOpacity style={styles.langButton}><Text style={styles.langButtonText}>HTML/CSS</Text></TouchableOpacity>
                <TouchableOpacity style={styles.langButton}><Text style={styles.langButtonText}>JavaScript</Text></TouchableOpacity>
                <TouchableOpacity style={styles.langButton}><Text style={styles.langButtonText}>C</Text></TouchableOpacity>
              </View>
